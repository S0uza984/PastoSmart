              ...
              <button className="w-full text-left px-4 py-3 bg-green-50 hover:bg-green-100 text-green-700 rounded-lg transition-colors">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-600">Visualizar e gerenciar lotes</p>
                  </div>
                </div>
              </button>
            </Link>
            ...
            <Link href="/peao/novo-lote">
              <button className="w-full text-left px-4 py-3 bg-green-50 hover:bg-green-100 text-green-700 rounded-lg transition-colors">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-medium">Novo Lote</p>
                    <p className="text-sm text-green-600">Cadastrar novo lote</p>
                  </div>
                </div>
              </button>
            </Link>
